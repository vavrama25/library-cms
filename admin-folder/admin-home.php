                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                            Activly borrowed books </div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo borrowedBooksCount(); ?></div>
                                    </div>
                                    <div class="col-auto">
                        ...
                        <div class="card border-left-warning shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                            All time borrowed books </div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo AllTimeborrowedBooksCount(); ?></div>
                                    </div>
                                    <div class="col-auto">
                                        <i class="fas fa-comments fa-2x text-gray-300"></i>
                                    </div>
